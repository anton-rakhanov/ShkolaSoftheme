...
namespace Librarium
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            localLibrary.ExtractLibraryItemBy(name: "Dead House");
            //xmlSerialer.SerializeLibraryItemInMemory(new Book("Blood For The King", "Damil Akra", LibraryItem.ItemType.Book, new DateTime(1965, 12, 01), 903, Book.GenreEnum.Drama));
